...
<body>
    <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('assets/cert-images/cert-without-photo.png'))) }}"
        class="image-base" />

    <div class="cert-name">Nama Lengkap</div>
    <div class="cert-parent-name">Nama dari orang tuanya</div>
    <div class="cert-birthdate">Kota/Kab., 01 Januari 1970</div>
</body>
